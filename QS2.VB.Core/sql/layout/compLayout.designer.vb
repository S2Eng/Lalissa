Partial Class compLayout
    ...
    Private Sub InitializeComponent()
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(compLayout))
        ...
        'OleDbConnection1
        '
        Me.OleDbConnection1.ConnectionString = "Provider=SQLNCLI11;Data Source=STYHL\SQLSRV2008;Integrated Security=SSPI;Initial " & _
    "Catalog=QS2_DEV"
    ...
    Public WithEvents daLayout As System.Data.SqlClient.SqlDataAdapter
    Public WithEvents daLayoutGrid As System.Data.SqlClient.SqlDataAdapter
