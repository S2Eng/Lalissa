...
#Region " Constructor "
    ...
    Public Sub New(ByVal mainWindow__1 As contTxtEditor2, ByVal textControl__2 As TXTextControl.TextControl)
...
#Region "  Properties  "
    ...
    Public Property MainWindow() As contTxtEditor2
        Get
            Return m_MainWindow
        End Get
        Set(ByVal value As contTxtEditor2)
            m_MainWindow = value
        End Set
    End Property
    Private m_MainWindow As contTxtEditor2
        ...
        If saveSettings.SavedFile <> "" Then
            ...
            If _documentStreamType <> saveSettings.SavedStreamType Then
                If saveSettings.SavedStreamType = TXTextControl.StreamType.HTMLFormat OrElse saveSettings.SavedStreamType = TXTextControl.StreamType.PlainText OrElse saveSettings.SavedStreamType = TXTextControl.StreamType.PlainAnsiText Then
                    If MessageBox.Show(My.Resources.strMsgFileHandler01, "Warning", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) = DialogResult.OK Then
                ...
                Select Case streamType
                    ...
                    Case TXTextControl.StreamType.AdobePDFA
                        If Not TextControl.FontSettings.EmbeddableFontsOnly Then
                            MessageBox.Show(My.Resources.strMsgFileHandler02, "Exporting to PDF/A not possible", MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
                            Return
                        End If
