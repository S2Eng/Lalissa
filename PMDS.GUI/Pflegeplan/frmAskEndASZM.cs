...
namespace PMDS.GUI
{
	public class frmAskEndASZM : frmBase
	{
		...
		private QS2.Desktop.ControlManagment.BaseLabel lblMarkierungBeendendenElemente;
		...
		/// </summary>
		//----------------------------------------------------------------------------
		public frmAskEndASZM(string sHeader)
		{
			InitializeComponent();
		...
		/// </summary>
		//----------------------------------------------------------------------------
		public frmAskEndASZM(string sHeader, ASZMLokalisiert[] raszm, PDxLokalisiert[] rpdx)
		{
			InitializeComponent();
			dtpEnd.DateTime = DateTime.Now.Date;
			RequiredFields();

			ProcessInfo(raszm, rpdx);
		...
		/// </summary>
		//----------------------------------------------------------------------------
		private void ProcessInfo(ASZMLokalisiert[] raszm, PDxLokalisiert[] rpdx)
		{
			...
			foreach(ASZMLokalisiert l in raszm) 
			{
				...
				{
					foreach(PDxLokalisiert pl in rpdx)
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmAskEndASZM));
            ...
            this.lblMarkierungBeendendenElemente = new QS2.Desktop.ControlManagment.BaseLabel();
            ...
            this.labInfo.Text = "A/S/Z/M beenden";
            // 
            // btnOK
            // 
            ...
            this.tbReason.Size = new System.Drawing.Size(416, 160);
            ...
            // 
            // lblMarkierungBeendendenElemente
            // 
            this.lblMarkierungBeendendenElemente.Location = new System.Drawing.Point(16, 288);
            this.lblMarkierungBeendendenElemente.Name = "lblMarkierungBeendendenElemente";
            this.lblMarkierungBeendendenElemente.Size = new System.Drawing.Size(336, 16);
            this.lblMarkierungBeendendenElemente.TabIndex = 16;
            this.lblMarkierungBeendendenElemente.Text = "Markieren Sie alle zu beendenden Elemente";
            // 
            // lbInfo
            // 
            ...
            this.lbInfo.Size = new System.Drawing.Size(416, 302);
            ...
            this.Controls.Add(this.lblMarkierungBeendendenElemente);
            ...
            this.Name = "frmAskEndASZM";
            this.ShowInTaskbar = false;
            this.Text = "Beenden einer ASZM";
