...
namespace PMDS
{
    ...
    public class frmMain : frmBase, IPMDSMenuFramework, IPMDSHeader
    {
        ...
        //----------------------------------------------------------------------------
        /// <summary>
        /// Notfall Definition wurde verändert
        /// </summary>
        //----------------------------------------------------------------------------
        ...
        //----------------------------------------------------------------------------
        /// <summary>
        /// Menüs je nach Rechte anzeigen / verstecken
        /// </summary>
        //----------------------------------------------------------------------------
            ...
            try
            {
                ...
                switch (e.Tool.Key)
                {
                    ...
                    case "btnVerwaltungFortbildungen":
                        ...
                        break;
                    case "btnÄrzteMergen":
                        PMDS.GUI.GUI.Main.frmÄrzteMergen frmÄrzteMergen1 = new GUI.GUI.Main.frmÄrzteMergen();
