...
namespace PMDS.GUI
{
    ...
    public class ucBenutzer : QS2.Desktop.ControlManagment.BaseControl, IUCBase
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.chkAnonym.CheckedChanged += new System.EventHandler(this.OnValueChanged);
            // 
            // cboAerzte
            // 
        ...
        public bool New()
        {
            using (frmEditPassword frm = new frmEditPassword())
            {
        ...
        {
            using (frmEditPassword frm = new frmEditPassword(Benutzer.BenutzerName))
            {
                if (frm.ShowDialog() == DialogResult.OK)
                {
