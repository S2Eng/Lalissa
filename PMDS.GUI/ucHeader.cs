...
namespace PMDS.GUI
{
	...
	public class ucHeader : QS2.Desktop.ControlManagment.BaseControl
    {
        ...
        public ucHeader()
		{
            ...
            this.contPatientUserPicker1.MainWindowHeader2 = this;
        }
		...
		private void InitializeComponent()
		{
            ...
            this.ucHeader_Fill_Panel.BackColor = System.Drawing.Color.WhiteSmoke;
        ...
        public void RefreshData(bool bRefreshPicker)
        {
            try
            {
                ...
                {
                    if (HeaderButtonClick != null)
                        HeaderButtonClick(ucHeader.lastButtonClicked, true);
                }
            }
            catch (Exception ex)
            {
