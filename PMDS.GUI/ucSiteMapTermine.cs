        ...
        private void _termine_TerminDoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        if (this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.EVALUIERUNG ||
                            this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.PLANUNG ||                          
                            this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.MEDIKAMENT ||
                            this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.NONE ||
                            this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.NOTFALL ||                           
                            this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.WUNDEN ||
                            this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.Klient
                            )
                        {
                            return;
                        }

                        PMDS.Global.db.ERSystem.dsTermine.vÜbergabeRow rÜbergabe = this._TermineEx.CurTerminRowÜbergabe;
                        if (((this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.DEKURS ||
                             this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.MASSNAHME ||
                             this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.TERMIN ||
                            rÜbergabe.IsIDPflegeplanNull())))
                        {
                            ...
                            //}
                            //else if (this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == (int)PMDS.Global.PflegeEintragTyp.UNEXP_MASSNAHME)
                            //{
                            ...
                            bool isDekurs = false;
                            if (this._TermineEx.CurTerminRowÜbergabe.Eintragstyp == 0)
                            {
                                isDekurs = true;
                            }
