...
namespace PMDS.GUI
{
    ...
    /// </remarks>
    public partial class ucRichTextBox : System.Windows.Forms.RichTextBox
    {
        ...
        public ucRichTextBox(RtfColor _textColor)
            : this()
        {
        ...
        public ucRichTextBox(RtfColor _textColor, RtfColor _highlightColor)
            : this()
        {
            textColor = _textColor;
