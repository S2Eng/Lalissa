...
namespace PMDS.GUI.BaseControls
{
	...
	/// </summary>
	//----------------------------------------------------------------------------
	public class FormularCombo : Infragistics.Win.UltraWinEditors.UltraComboEditor
	{

		private FormularManager					_manager = new FormularManager();
		private dsFormular.FormularDataTable	_dt;
		...
		public void RefreshList(Guid IDToSet)
		{
			...
			try
			{
				...
				foreach(dsFormular.FormularRow r in _dt)
