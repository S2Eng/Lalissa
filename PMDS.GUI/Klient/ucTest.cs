...
namespace PMDS.GUI.Klient
{
    ...
    public partial class ucTest : UserControl
    {
        ...
        private void ucTestDokument_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        void PatientIDChanged(Guid IDPatient, eCurrentPatientChange typ)
        {
            try
            {
        ...
        public bool showDocument()
        {
            try
            {
                //this.clFolder.openFile(fileInfo.FullName.Trim(), "", false, false);
                ...
                if (this._docuDocumentFileTypeSaved.Trim().Equals(".pdf", StringComparison.CurrentCultureIgnoreCase))
                {
                    ...
                    //this.pdfViewer1.LoadDocument(ms);
                    //this.pdfViewer1.ResumeLayout();
                    //SetPdfViewer(true);
                ...
                else
                {
                    ...
                    clFolder1.openFile(FileTmp.Trim(), "", true, false);
                }
