...
namespace PMDS.Klient.UIKostenträger
{
    ...
    public class cKostenträger
    {
                ...
                public bool newFIBUKonto(PMDS.Global.db.Global.ds_abrechnung.dsKostentraeger.KostentraegerDataTable tKostenträger,
                                    ref string sNewFIBUKonto, ref int nNewFIBUKonto,string Bereich)
        {
            try
            {
                ...
                int nLastNr = 0;
                foreach (PMDS.Global.db.Global.ds_abrechnung.dsKostentraeger.KostentraegerRow rKost in tKostenträger)
                {
                    int nNrActuell = -1;
