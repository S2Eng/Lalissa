...
namespace PMDS.GUI
{
    public partial class ucAusscheidungPOP : ucAnamneseModellgruppeBase
    {
        public ucAusscheidungPOP()
        {
            InitializeComponent();
            ucAnamnesePDX1.Modellgruppe = (int)POPModellgruppen.Ausscheidung;
        ...
        private void AddControlsToDataBindings()
        {
            ...
            ListDataBindingHelper.AddRange(new DataBindingHelper[]{new DataBindingHelper(opStuhlgangProblemeJN, "Value", "StuhlgangProblemeJN"), 
                                                    ...
                                                    new DataBindingHelper(opAussclagartigeHautveraendJN, "Value", "AusschlagartigeHautveraendJN"),
                                                    new DataBindingHelper(tbAussclagartigeHautveraendIn, "Text", "AusschlagartigeHautveraendIn"),
                                                    new DataBindingHelper(tbAusschlagartigeHautveraend, "Text", "AusschlagartigeHautveraend"),
                                                    ...
                                                    new DataBindingHelper(tbMundschleimhautZustand, "Text", "MundschleimhautZustand"),
                                                    ...
                                                    new DataBindingHelper(tbDecubitsSkala, "Text", "DecubitusSkala"),
                                                    new DataBindingHelper(tbDecubitusPunkte, "Value", "DecubitusPunkte"),
                                                    new DataBindingHelper(opDecubitusFoto, "Value", "DecubitusFoto"),
