namespace ScintillaNET.Demo {
	partial class TextEditMainForm {
		/// <summary>
		...
		private void InitializeComponent() {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(TextEditMainForm));
			...
			this.selectLineToolStripMenuItem.Text = "Zeile markieren";
			...
			this.clearSelectionToolStripMenuItem.Text = "Auswahl zurücksetzen";
			...
			this.indentSelectionToolStripMenuItem.Text = "Einzug vergößern";
			...
			this.outdentSelectionToolStripMenuItem.Text = "Einzug verringern";
			...
			this.uppercaseSelectionToolStripMenuItem.Text = "In Großbuchstaben";
			...
			this.lowercaseSelectionToolStripMenuItem.Text = "In Kleinbuchstaben";
			...
			this.findToolStripMenuItem.Text = "Text suchen";
			...
			//this.findDialogToolStripMenuItem.Text = "Suche";
			...
			//this.findAndReplaceToolStripMenuItem.Text = "Suchen und Ersetzen";
			...
			this.goToLineToolStripMenuItem.Text = "Springe zu Zeilennummer";
			// 
			...
			this.indentGuidesItem.Text = "Einzüge anzeigen";
			...
			this.hiddenCharactersItem.Text = "Leerzeichen markieren";
			...
			this.zoomInToolStripMenuItem.Text = "Vergößern";
			...
			this.zoomOutToolStripMenuItem.Text = "Verkleinern";
			...
			//this.collapseAllToolStripMenuItem.Text = "Alles einklappen";
			...
			//this.expandAllToolStripMenuItem.Text = "Alles ausklappen";
			...
			this.BtnNextSearch.Tag = "Finde nächstes (Enter)";
			...
			this.BtnPrevSearch.Tag = "Finde vorheriges (Shift+Enter)";
			...
			this.BtnCloseSearch.Tag = "Suchfenster schließen (Esc)";
			...
			this.openFileDialog.FileName = "Neue Datei";
			...
			this.Name = "S2-Texteditor";
			this.Text = "S2-Texteditor";
