...
namespace ScintillaNET.Demo {
	public partial class TextEditMainForm : Form 
	{
        ...
        public TextEditMainForm(string sCaption, string sContent) 
		{
			InitializeComponent();
        ...
        public TextEditMainForm(string sCaption, StringBuilder sSB)
        {
            InitializeComponent();
            this.sCaption = sCaption;
            this.sSB = sSB;
		...
		private void MainForm_Load(object sender, EventArgs e) 
		{
			...
			this.FileName.Text = sCaption;
			if (sSB == null)
			{
				TextArea.Text = sContent;
            }
			else
			{
                TextArea.Text = sSB.ToString();
            }
        }
