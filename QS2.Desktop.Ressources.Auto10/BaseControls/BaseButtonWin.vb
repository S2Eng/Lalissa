...
'PMDS.Global.BaseElements
Public Class BaseButtonWin
    ...
    Private Sub BaseButtonWin_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
