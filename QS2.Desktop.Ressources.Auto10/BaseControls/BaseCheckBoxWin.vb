...
Public Class BaseCheckBoxWin
    ...
    Private Sub BaseCheckBoxWin_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BaseCheckBoxWin_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
