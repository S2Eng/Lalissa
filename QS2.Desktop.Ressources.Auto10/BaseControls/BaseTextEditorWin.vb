...
Public Class BaseTextEditorWin
    ...
    Private Sub BaseTextEditorWin_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BaseTextEditorWin_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
