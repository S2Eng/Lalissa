...
Public Class BaseLabel
    ...
    Private Sub BaseLabel_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BaseLabel_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
