...
Public Class BaseDateTimeEditorWin
    ...
    Private Sub BaseDateTimeEditorWin_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BaseDateTimeEditorWin_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
