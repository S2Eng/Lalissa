...
Public Class BaseGroupBox
    ...
    Private Sub BaseGroupBox_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BaseGroupBox_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
