...
Public Class BaseTextEditor
    ...
    Private Sub BaseTextEditor_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BaseTextEditor_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
