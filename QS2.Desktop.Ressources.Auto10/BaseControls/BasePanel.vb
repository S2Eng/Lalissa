...
Public Class BasePanel
    ...
    Private Sub BasePanel_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BasePanel_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
