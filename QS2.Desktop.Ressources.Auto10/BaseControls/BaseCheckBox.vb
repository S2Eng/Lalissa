...
Public Class BaseCheckBox
    ...
    Private Sub BaseCheckBox_VisibleChanged(sender As Object, e As EventArgs) Handles MyBase.VisibleChanged
        Try
    ...
    Private Sub BaseCheckBox_MouseEnter(sender As Object, e As EventArgs) Handles MyBase.MouseEnter
        Try
