        ...
        public void loadData()
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        IDGroupToLoad = this._FldShort[this._FldShort.Count() - 1];
                    }
                    else if (this._typMultiControl == core.vb.sqlAdmin.eTypStayAdditions.assignStay)
                    {
                        this.dropDownStays1.loadData(dataStayTmp.rPatient.ID, this.ownMCCriteria1.Application,
                                                        rStayTmp.IDParticipant, core.Enums.eStayTyp.Stay, dataStayTmp.rPatient.IDGuid);  // OMC.IDApplication.Check
                        IDGroupToLoad = this._FldShort[0];
                    }

                    this.sqlAdmin1.getStayAdditions(rStayTmp.ID, rStayTmp.IDParticipant, this.dsAdminShow, core.vb.sqlAdmin.eTypSelStayAdditions.idStay,
                                this._typMultiControl, this.ownMCCriteria1.Application, System.Guid.Empty, core.vb.sqlAdmin.eTypStayAdditions.multiSelListsRoles.ToString(), false );  // OMC.IDApplication.Check
                    this.sqlAdmin1.getStayAdditions(-999, "", this.dsAdminShow, core.vb.sqlAdmin.eTypSelStayAdditions.idObject,
                                                    this._typMultiControl, this.ownMCCriteria1.Application, dataStayTmp.rPatient.IDGuid, "", false );   
                }
                ...
                if (this._typMultiControl == core.vb.sqlAdmin.eTypStayAdditions.multiSelLists)
                {
                    ...
                    this.setGridUI(true);
                    //foreach (qs2.core.vb.dsAdmin.tblStayAdditionsRow rStayAdd in this.dsAdminShow.tblStayAdditions)
                    //{
                    //    dfsdf

                    //    this.translateRowStayAddition(rStayAdd);
                    //}
                    //this.setGridUI(true);
                }
                ...
                if (this._typMultiControl == core.vb.sqlAdmin.eTypStayAdditions.multiSelLists)
                {
                    this.gridData.DisplayLayout.Bands[0].SortedColumns.Clear();
                    this.gridData.DisplayLayout.Bands[0].SortedColumns.Add(this.dsAdminShow.tblSelListEntries.sortColumn.ColumnName, false);
                    ...
                    this.gridData.Rows.ExpandAll(true);
                }
                else if (this._typMultiControl == core.vb.sqlAdmin.eTypStayAdditions.assignStay)
                {
                    this.gridData.DisplayLayout.Bands[0].SortedColumns.Clear();
                    this.gridData.DisplayLayout.Bands[0].SortedColumns.Add(qs2.core.generic.columnNameText, false);
                    this.gridData.Rows.ExpandAll(true);
                }
            ...
            {
                qs2.core.Protocol.doExcept(ex.ToString(), "ownMultiGridSelList.loadData", "", false, true,
                                                                this.ownMCCriteria1.Application,
                                                                qs2.core.Protocol.alwaysShowExceptionMulticontrol, qs2.core.Protocol.eTypeError.Error);
            }
        }
