...
namespace qs2.ui.print
{
    ...
    public partial class contQueryDef : UserControl
    {
        ...
        public CorePrintWindowAuto.dsPrintWindow dsPrintWindow1 = null;
        public string ApplicationLast = "";
        public printTxtControl printTxtControl1 = new printTxtControl();
        ...
        public void addPlaceholder()
        {
            try
            {
                string NamePlaceholderVar = Microsoft.VisualBasic.Interaction.InputBox(qs2.core.language.sqlLanguage.getRes("NamePlaceholder"), "", "", 0, 0);
                if (string.IsNullOrEmpty(NamePlaceholderVar))
                {
                    this.sqlAdmin1.addRowQueriesDef(this.dsAdmin1.tblQueriesDef);
                    ...
                    if (this.dsPrintWindow1 == null || string.IsNullOrEmpty(this.ApplicationLast) || !this.ApplicationLast.Equals(rNewEdit.ApplicationOwn, StringComparison.InvariantCulture))
                    {
                        this.ApplicationLast = this.mainWindow.getSelectedApplication();
                        this.dsPrintWindow1 = printTxtControl1.getDataSetPrintDll(this.ApplicationLast);
                    }
                    ...
                    printTxtControl1.GetChaptersForField(rNewEdit.ApplicationOwn, rNewEdit.QryColumn, rNewEdit, IsSQLServerField, selRowGrid, rNewEdit.Chapter,
                                                            ref this.dsPrintWindow1, ref this.colChapterTransl, ref this.colChaptersTransl, StayType, this.db);
            ...
            try
            {
                if (this.isInEditMode)
                {
                    ...
                    else if (qs2.core.generic.sEquals(e.Cell.Column, this.dsAdmin1.tblQueriesDef.ConditionColumn.ColumnName))
                    {
                        ...
                        if (qs2.core.generic.sEquals(MyTranslate(e.Cell.Text.ToString()),
                                new List<object> { MyTranslate(qs2.core.sqlTxt.between),
                                                    MyTranslate(qs2.core.sqlTxt.notBetween),
                                                    MyTranslate(qs2.core.sqlTxt.like),
                                                    MyTranslate(qs2.core.sqlTxt.In),
                                                    MyTranslate(qs2.core.sqlTxt.NotIn),
                                                    MyTranslate(qs2.core.sqlTxt.isNull),
                                                    MyTranslate(qs2.core.sqlTxt.isNotNull) }
                            ))
                        {
        ...
        private string MyTranslate(string STranslate)
        {
        ...
        private void sortByChapterToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                this.Cursor = Cursors.WaitCursor;
                ...
                ui1.SortFieldsByChapter(ref this.gridQueryDef, this.mainWindow.getSelectedApplication(), this.dsAdmin1, this.colSerialNr, this.colLineNr, this.colControlNr, this.colChapterTransl);
        ...
        private void checkChaptersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                this.Cursor = Cursors.WaitCursor;

                printTxtControl printTxtControl1 = new printTxtControl();
                CorePrintWindowAuto.dsPrintWindow dsPrintWindow1 = printTxtControl1.getDataSetPrintDll(this.mainWindow.getSelectedApplication());
                ...
                foreach (Infragistics.Win.UltraWinGrid.UltraGridRow row in this.gridQueryDef.Rows)
                {
                    ...
                    printTxtControl1.GetChaptersForField(rQry.ApplicationOwn, rQry.QryColumn, rQry, rQry.IsSQLServerField, row, rQry.Chapter, ref dsPrintWindow1, 
                                                            ref this.colChapterTransl, ref this.colChaptersTransl, StayType, this.db);
                    rQry.ChaptersDone = true;
                }
