...
Public Class contComboUserAccounts
    ...
    Public Sub initControl(ByRef ComboStyle As UltraComboStyle)
        ...
        Catch ex As Exception
            Throw New Exception("contComboUserAccounts.initControl: " + ex.ToString())
        End Try
    End Sub
    Public Sub loadUserAccounts(ByVal typ As compUserAccounts.eTypEMailAccount, ByVal usr As String)
        ...
        Catch ex As Exception
            Throw New Exception("contComboUserAccounts.loadUserAccounts: " + ex.ToString())
        End Try
    End Sub
    ...
    Public Function getSelectedUserAccount(ByVal withMsgBox As Boolean) As dsUserAccounts.tblUserAccountsRow
        ...
        Catch ex As Exception
            Throw New Exception("contComboUserAccounts.getSelectedUserAccount: " + ex.ToString())
        End Try
    End Function
    ...
    Public Sub clearSelection()
        ...
        Catch ex As Exception
            Throw New Exception("contComboUserAccounts.clearSelection: " + ex.ToString())
        End Try
    End Sub
