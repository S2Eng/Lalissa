...
Partial Public Class dsPostbox
    ...
    Partial Public Class tblPostboxDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddtblPostboxRow(ByVal ID As System.Guid, ByVal Übernehmen As Boolean, ByVal multiTIFF As Boolean, ByVal Datei As String, ByVal Grösse As Double, ByVal Erstellt As Date, ByVal DateiMitPfad As String) As tblPostboxRow
            Dim rowtblPostboxRow As tblPostboxRow = CType(Me.NewRow,tblPostboxRow)
            Dim columnValuesArray() As Object = New Object() {ID, Übernehmen, multiTIFF, Datei, Grösse, Erstellt, DateiMitPfad}
        ...
        Private Sub InitClass()
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("DocumentKey1", New Global.System.Data.DataColumn() {Me.columnID}, false))
