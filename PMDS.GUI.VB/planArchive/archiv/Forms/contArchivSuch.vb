...
#Region " Vom Windows Form Designer generierter Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.UGridDokumenteGefunden3 = New Infragistics.Win.UltraWinGrid.UltraGrid()
        ...
        Me.PanelGrid.Controls.Add(Me.UGridDokumenteGefunden3)
        ...
        '
        'UGridDokumenteGefunden3
        '
        Me.UGridDokumenteGefunden3.ContextMenuStrip = Me.ContextMenuDokumenteListeC
        Appearance1.BackColor = System.Drawing.Color.White
        Appearance1.BackColor2 = System.Drawing.Color.White
        Me.UGridDokumenteGefunden3.DisplayLayout.Appearance = Appearance1
        Me.UGridDokumenteGefunden3.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid
        Me.UGridDokumenteGefunden3.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.[False]
        Appearance2.BackColor = System.Drawing.Color.White
        Me.UGridDokumenteGefunden3.DisplayLayout.GroupByBox.Appearance = Appearance2
        Me.UGridDokumenteGefunden3.DisplayLayout.GroupByBox.Prompt = "Ziehen Sie eine Spalte herein welche Sie gruppieren möchten."
        Appearance3.BackColor = System.Drawing.Color.White
        Me.UGridDokumenteGefunden3.DisplayLayout.GroupByBox.PromptAppearance = Appearance3
        Appearance4.BackColor = System.Drawing.Color.DarkGray
        Appearance4.BackColor2 = System.Drawing.Color.DarkGray
        Appearance4.ForeColor = System.Drawing.Color.White
        Me.UGridDokumenteGefunden3.DisplayLayout.Override.ActiveRowAppearance = Appearance4
        Appearance5.BackColor = System.Drawing.Color.DarkGray
        Appearance5.BackColor2 = System.Drawing.Color.DarkGray
        Appearance5.ForeColor = System.Drawing.Color.White
        Me.UGridDokumenteGefunden3.DisplayLayout.Override.SelectedRowAppearance = Appearance5
        Me.UGridDokumenteGefunden3.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy
        Me.UGridDokumenteGefunden3.Dock = System.Windows.Forms.DockStyle.Fill
        Me.UGridDokumenteGefunden3.Location = New System.Drawing.Point(0, 0)
        Me.UGridDokumenteGefunden3.Name = "UGridDokumenteGefunden3"
        Me.UGridDokumenteGefunden3.Size = New System.Drawing.Size(538, 421)
        Me.UGridDokumenteGefunden3.TabIndex = 444
        Me.UGridDokumenteGefunden3.Text = "UltraGrid1"
        '
        ...
        CType(Me.UGridDokumenteGefunden3, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Public Sub resetForm()
        Try
            ...
            Me.UGridDokumenteGefunden3.DataSource = Nothing
            Me.UGridDokumenteGefunden3.DataBind()
    ...
    Public Sub DokumentSuchen(ByVal leerAnzeigen As Boolean, ByVal nurPapierkorb As Boolean, doInit As Boolean)
        Try
            ...
            Me.UGridDokumenteGefunden3.DataSource = Me.dataDokumenteSuchen
            Me.UGridDokumenteGefunden3.DataBind()
    ...
    Public Sub initGridDokumenteGefunden(ByRef dataDokumenteSuchen As dsPlanArchive)
        Try
            ...
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Bezeichnung").Width = 350
            ...
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Bezeichnung").Header.Caption = "Bezeichnung"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Bezeichnung").DataType.GetType("System.String")

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGröße").Width = 80
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGröße").Header.Caption = "Grösse (Byte)"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGröße").DataType.GetType("System.Int32")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGröße").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Right
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGröße").Format = "###,###,##0"

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltAm").Width = 110
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltAm").Header.Caption = "Abgelegt am"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltAm").DataType.GetType("System.Date")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltAm").Format = "yyyy-MM-dd HH:mm"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltAm").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltVon").Width = 150
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltVon").Header.Caption = "Von"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ErstelltVon").DataType.GetType("System.String")

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Wichtigkeit").Width = 80
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Wichtigkeit").Header.Caption = "Wichtigkeit"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Wichtigkeit").DataType.GetType("System.String")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Wichtigkeit").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Winzip").Width = 50
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Winzip").Header.Caption = "Winzip"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Winzip").DataType.GetType("System.Boolean")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Winzip").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Winzip").Style = Infragistics.Win.UltraWinGrid.ColumnStyle.CheckBox

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Extern").Width = 50
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Extern").Header.Caption = "Extern"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Extern").DataType.GetType("System.Boolean")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Extern").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Extern").Style = Infragistics.Win.UltraWinGrid.ColumnStyle.CheckBox

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentErstellt").Width = 100
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentErstellt").Header.Caption = "Datei erstellt am"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentErstellt").DataType.GetType("System.Date")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentErstellt").Format = "yyyy-MM-dd"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentErstellt").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center
            ' Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentErstellt").Header.Appearance.Image = ImageList.Images(10)

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGeändert").Width = 110
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGeändert").Header.Caption = "Letzt Änderung am"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGeändert").DataType.GetType("System.Date")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGeändert").Format = "yyyy-MM-dd"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGeändert").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center
            ' Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGeändert").Header.Appearance.Image = ImageList.Images(10)

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigVon").Width = 80
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigVon").Header.Caption = "Gültig von"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigVon").DataType.GetType("System.Date")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigVon").Format = "yyyy-MM-dd"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigVon").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigBis").Width = 80
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigBis").Header.Caption = "Gültig bis"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigBis").DataType.GetType("System.Date")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigBis").Format = "yyyy-MM-dd"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("GültigBis").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("BezeichnungOrdner").Width = 140
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("BezeichnungOrdner").Header.Caption = "Gültig bis"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("BezeichnungOrdner").DataType.GetType("System.String")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("BezeichnungOrdner").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Left
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("BezeichnungOrdner").Header.Caption = "Ordner"

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DateinameTyp").Width = 50
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DateinameTyp").Header.Caption = "Typ"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DateinameTyp").DataType.GetType("System.String")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DateinameTyp").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Center

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DateinameOrig").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("VerzeichnisOrig").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("IDDokumenteintrag").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("IDDokument").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("IDOrdner").Hidden = True

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Archivordner").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DateinameArchiv").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Notiz").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Winzip").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Extern").Hidden = True

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGröße").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Wichtigkeit").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Winzip").Hidden = True

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Extern").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentErstellt").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("DokumentGeändert").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("IDObject").Hidden = True
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("ID_guid").Hidden = True

            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Patient").Width = 170
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Patient").Header.Caption = "Klient"
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Patient").DataType.GetType("System.String")
            Me.UGridDokumenteGefunden3.DisplayLayout.Bands(0).Columns("Patient").CellAppearance.TextHAlign = Infragistics.Win.HAlign.Left
            ...
            Me.UGridDokumenteGefunden3.DisplayLayout.Appearance.BackColor = Color.White
            Me.UGridDokumenteGefunden3.DisplayLayout.Appearance.BackColor2 = Color.White
            Me.UGridDokumenteGefunden3.UseOsThemes = Infragistics.Win.DefaultableBoolean.True
            Me.UGridDokumenteGefunden3.DisplayLayout.Override.RowAlternateAppearance.BackColor = Color.White
    ...
    Private Sub MItemSpeichernUnterListeS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MItemSpeichernUnterListeS.Click
        Try
            ...
            If Not gen.IsNull(Me.UGridDokumenteGefunden3.ActiveRow) Then
                If Not gen.IsNull(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDDokumenteintrag").Value) Then
                    Dim ID_DokuSEARCH As New System.Guid(CStr(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDDokumenteintrag").Value))
    ...
    Private Sub MItemInfoDokumentListeS_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MItemInfoDokumentListeS.Click
        ...
        Try
            ...
            If Not General.IsNull(Me.UGridDokumenteGefunden3.ActiveRow) Then
                Dim text As String = ""
                If Not General.IsNull(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDDokumenteintrag").Value) Then
                    Dim IDDoku As New System.Guid(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDDokumenteintrag").Value.ToString)
    ...
    Public Sub dokuÖffnenGrid()
        Try
            ...
            If Not gen.IsNull(Me.UGridDokumenteGefunden3.ActiveRow) Then
                If Me.UGridDokumenteGefunden3.ActiveRow.Cells.Exists("IDDokumenteintrag") Then
                    If Not gen.IsNull(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDDokumenteintrag").Value) Then
                        Dim ID_DokuSEARCH As New System.Guid(CStr(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDDokumenteintrag").Value))
    ...
    Private Sub InDenPapierkorbLIToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles InDenPapierkorbLIToolStripMenuItem.Click
        Try
            ...
            If gen.IsNull(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDOrdner").Value) Then Exit Sub
            Dim IDOrdner As New System.Guid(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDOrdner").Value.ToString)

            If gen.IsNull(IDOrdner) Then Exit Sub

            Me.Cursor = Cursors.WaitCursor
            If Not gen.IsNull(Me.UGridDokumenteGefunden3.ActiveRow) Then
                Dim IDDokumenteneintrag As New System.Guid(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDDokumenteintrag").Value.ToString)
                Dim clDelete As New cArchive
    ...
    Private Sub DokumentHinzufügenToolStripMenuItem1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DokumentHinzufügenToolStripMenuItem1.Click
        ...
        Try
            ...
            Dim IDOrdner As New System.Guid
            IDOrdner = Nothing
            If Not gen.IsNull(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDOrdner").Value) Then
                IDOrdner = New System.Guid(Me.UGridDokumenteGefunden3.ActiveRow.Cells("IDOrdner").Value.ToString)
            End If
            Me.DokumentHinzufügen(IDOrdner)
    ...
    Private Sub UGridDokumenteGefunden3_BeforeCellActivate(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.CancelableCellEventArgs) Handles UGridDokumenteGefunden3.BeforeCellActivate
        Try
        ...
        End Try
    End Sub
    Private Sub UGridDokumenteGefunden3_BeforeRowsDeleted(ByVal sender As Object, ByVal e As Infragistics.Win.UltraWinGrid.BeforeRowsDeletedEventArgs) Handles UGridDokumenteGefunden3.BeforeRowsDeleted
        Try
        ...
        End Try
    End Sub
    Private Sub UGridDokumenteGefunden3_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles UGridDokumenteGefunden3.DoubleClick
        Try
            Me.dokuÖffnenGrid()
        ...
        End Try
    End Sub
    Private Sub UGridDokumenteGefunden3_InitializeLayout(ByVal sender As System.Object, ByVal e As Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs) Handles UGridDokumenteGefunden3.InitializeLayout
        Try
