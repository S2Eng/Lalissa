...
Public Class clUIElements
    ...
    Public Function Menu_loadContainer(ByRef UltraToolbarsManager As UltraToolbarsManager, ByVal Band As Integer, _
        ...
        Catch ex As Exception
            Throw New Exception("Menu_loadContainer: " + ex.ToString())
        End Try
    End Function
    Private Function Menu_loadContainer_Rek(ByRef Tools As ToolsCollection, ByRef pan As System.Windows.Forms.UserControl, ByVal keyToLoad As String)
        Dim gen As New GeneralArchiv()
        Try
            Dim Key As String
            ...
            For Each Tool In Tools
                If Tool.Key = keyToLoad Then
                    If Tool.GetType.ToString() = "Infragistics.Win.UltraWinToolbars.PopupControlContainerTool" Then
                        ...
                        PopupControlContainerTool.SharedProps.Caption = "Zwischenablage"
        ...
        Catch ex As Exception
            Throw New Exception("Menu_loadContainer_Rek: " + ex.ToString())
        End Try
    End Function
