...
namespace WCFServicePMDS.BAL
{
    ...
    public class MessagesBAL : ImessagesBAL
    {
        ...
        public WCFServicePMDS.BAL.DTO.MessagesDto messagesUnreadedUsr(string ClientsMessage, string TypeMessage, Guid UserId, DateTime dFromTmp, DateTime dToTmp)
        {
            try
            {
                using (Models.DB.PMDSDevContext context = DAL.dbBase.CreateContextEFCorePMDS())
                {
                    ...
                    WCFServicePMDS.BAL.DTO.MessagesDto dtoRet = new DTO.MessagesDto() { };
                    dtoRet.lMessages = Mapping.MergeListData<List<MessagesDTO>>(tM.Select(x => x as object).ToList()).First();
                }
        ...
        public WCFServicePMDS.BAL.DTO.MessagesDto messagesAllUsr(string ClientsMessage, string TypeMessage, Guid UserId, DateTime dFromTmp, DateTime dToTmp)
        {
            try
            {
                using (Models.DB.PMDSDevContext context = DAL.dbBase.CreateContextEFCorePMDS())
