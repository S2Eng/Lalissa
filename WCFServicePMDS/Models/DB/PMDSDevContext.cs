...
namespace WCFServicePMDS.Models.DB
{
    public partial class PMDSDevContext : DbContext
    {
        ...
        public virtual DbSet<CommAsync> CommAsync { get; set; }
        public virtual DbSet<CommAsyncClients> CommAsyncClients { get; set; }
        ...
        public virtual DbSet<MessagesToUsers> MessagesToUsers { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Aufenthalt>(entity =>
            {
                ...
                entity.Property(e => e.ElgakontaktbestätigungContactId)
                    .IsRequired()
                    .HasColumnName("ELGAKontaktbestätigungContactID")
                    .HasMaxLength(300)
                    .HasDefaultValueSql("('')");
                ...
                entity.Property(e => e.ElgalocalId)
                    .IsRequired()
                    .HasColumnName("ELGALocalID")
                    .HasMaxLength(300)
                    .HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<CommAsync>(entity =>
            {
                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .HasDefaultValueSql("(newid())");

                entity.Property(e => e.ClientsMessage)
                    .IsRequired()
                    .HasMaxLength(500)
                    .HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<CommAsyncClients>(entity =>
            {
                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .ValueGeneratedNever();
                ...
                entity.Property(e => e.IdcommAsync).HasColumnName("IDCommAsync");

                entity.HasOne(d => d.IdcommAsyncNavigation)
                    .WithMany(p => p.CommAsyncClients)
                    .HasForeignKey(d => d.IdcommAsync)
                    .HasConstraintName("FK_CommAsyncClients_CommAsync");
            });
            ...
            modelBuilder.Entity<Klinik>(entity =>
            {
                ...
                entity.Property(e => e.AuthUniversalId)
                    .IsRequired()
                    .HasColumnName("AuthUniversalID")
                    .HasMaxLength(300)
                    .HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<MedizinischeDaten>(entity =>
            {
                ...
                entity.Property(e => e.Iddocu).HasColumnName("IDDocu");
            ...
            modelBuilder.Entity<MessagesToUsers>(entity =>
            {
                entity.Property(e => e.Id)
                    .HasColumnName("ID")
                    .ValueGeneratedNever();
                ...
                entity.HasOne(d => d.IdmessagesNavigation)
                    ...
                    .HasConstraintName("FK_MessagesToUsers_Messages");
            });
            ...
            modelBuilder.Entity<Patient>(entity =>
            {
                ...
                entity.Property(e => e.Dnranmerkung)
                    .IsRequired()
                    .HasColumnName("DNRAnmerkung")
                    .HasMaxLength(1000)
                    .HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<TblDokumenteintrag>(entity =>
            {
                ...
                entity.Property(e => e.ElgacreatedInPmds).HasColumnName("ELGACreatedInPMDS");

                entity.Property(e => e.ElgadocuType)
                    .IsRequired()
                    .HasColumnName("ELGADocuType")
                    .HasMaxLength(100)
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.Elgastorniert).HasColumnName("ELGAStorniert");

                entity.Property(e => e.ElgastorniertDatum)
                    .HasColumnName("ELGAStorniertDatum")
                    .HasColumnType("datetime");

                entity.Property(e => e.ElgastorniertUser)
                    .IsRequired()
                    .HasColumnName("ELGAStorniertUser")
                    .HasMaxLength(150)
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.ElgauniqueId)
                    .IsRequired()
                    .HasColumnName("ELGAUniqueID")
                    .HasMaxLength(300)
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.Elgauuid)
                    .IsRequired()
                    .HasColumnName("ELGAUUID")
                    .HasMaxLength(300)
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.Elgaübertragen)
                    .HasColumnName("ELGAÜbertragen")
                    .HasDefaultValueSql("((-1))");
                ...
                entity.Property(e => e.FileStylesheet)
                    .IsRequired()
                    .HasMaxLength(300)
                    .HasDefaultValueSql("('')");
                ...
                entity.Property(e => e.IsElgadocu).HasColumnName("IsELGADocu");
