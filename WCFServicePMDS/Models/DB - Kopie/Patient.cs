...
namespace WCFServicePMDS.Models.DB
{
    public partial class Patient
    {
        public Patient()
        {
            ...
            PatientAbwesenheit = new HashSet<PatientAbwesenheit>();
            ...
            Rehabilitation = new HashSet<Rehabilitation>();
            SachwalterNavigation = new HashSet<Sachwalter>();
        ...
        public string ElgakontaktbestätigungLocalId { get; set; }
        ...
        public virtual ICollection<PatientAbwesenheit> PatientAbwesenheit { get; set; }
        ...
        public virtual ICollection<Rehabilitation> Rehabilitation { get; set; }
        public virtual ICollection<Sachwalter> SachwalterNavigation { get; set; }
