...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Aufenthalt>(entity =>
            {
                ...
                entity.Property(e => e.ElgakontaktbestätigungDatum)
                    .HasColumnName("ELGAKontaktbestätigungDatum")
                    .HasColumnType("datetime");

                entity.Property(e => e.ElgakontaktbestätigungJn).HasColumnName("ELGAKontaktbestätigungJN");

                entity.Property(e => e.ElgakontaktbestätigungStornoDatum)
                    .HasColumnName("ELGAKontaktbestätigungStornoDatum")
                    .HasColumnType("datetime");

                entity.Property(e => e.ElgakontaktbestätigungStornoJn).HasColumnName("ELGAKontaktbestätigungStornoJN");

                entity.Property(e => e.ElgakontaktbestätigungStornoUser)
                    .IsRequired()
                    .HasColumnName("ELGAKontaktbestätigungStornoUser")
                    .HasMaxLength(100)
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.ElgakontaktbestätigungUser)
                    .IsRequired()
                    .HasColumnName("ELGAKontaktbestätigungUser")
                    .HasMaxLength(200)
                    .HasDefaultValueSql("('')");
                ...
                entity.Property(e => e.Elgasoouser)
                    .IsRequired()
                    .HasColumnName("ELGASOOUser")
                    .HasMaxLength(100)
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.Elgasoozeitpunkt)
                    .HasColumnName("ELGASOOZeitpunkt")
                    .HasColumnType("datetime");
            ...
            modelBuilder.Entity<AuswahlListe>(entity =>
            {
                ...
                entity.Property(e => e.ElgaVersion)
                    .IsRequired()
                    .HasColumnName("ELGA_Version")
                    .HasMaxLength(255)
                    .HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<AuswahlListeGruppe>(entity =>
            {
                ...
                entity.Property(e => e.ElgaJn).HasColumnName("ElgaJN");

                entity.Property(e => e.ElgaUseMeaning).HasColumnName("ELGA_UseMeaning");
            ...
            modelBuilder.Entity<Benutzer>(entity =>
            {
                ...
                entity.Property(e => e.Elgapwd)
                    .IsRequired()
                    .HasColumnName("ELGAPwd")
                    .HasMaxLength(100)
                    .HasDefaultValueSql("('')");

                entity.Property(e => e.ElgapwdLastChange)
                    .HasColumnName("ELGAPwdLastChange")
                    .HasColumnType("datetime");
            ...
            modelBuilder.Entity<Elgaprotocoll>(entity =>
            {
                ...
                entity.HasOne(d => d.IdaufenthaltNavigation)
                    .WithMany(p => p.Elgaprotocoll)
                    .HasForeignKey(d => d.Idaufenthalt)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_ELGAProtocoll_IDAufenthalt");

                entity.HasOne(d => d.IdbenutzerNavigation)
                    .WithMany(p => p.Elgaprotocoll)
                    .HasForeignKey(d => d.Idbenutzer)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK_ELGAProtocoll_IDBenutzer");

                entity.HasOne(d => d.IdpatientNavigation)
                    .WithMany(p => p.Elgaprotocoll)
                    .HasForeignKey(d => d.Idpatient)
                    .HasConstraintName("FK_ELGAProtocoll_IDPatient");
            });
            ...
            modelBuilder.Entity<Patient>(entity =>
            {
                ...
                entity.Property(e => e.Elgaabgemeldet)
                    .HasColumnName("ELGAAbgemeldet")
                    .HasDefaultValueSql("((0))");

                entity.Property(e => e.ElgakontaktbestätigungLocalId)
                    .IsRequired()
                    .HasColumnName("ELGAKontaktbestätigungLocalID")
                    .HasMaxLength(500)
                    .HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<PatientAerzte>(entity =>
            {
                ...
                entity.Property(e => e.ElgaHausarztJn).HasColumnName("ELGA_HausarztJN");
            ...
            modelBuilder.Entity<PflegeEintrag>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Id, e.Idaufenthalt, e.IdpflegePlan, e.Idbenutzer, e.Ideintrag, e.DatumErstellt, e.Zeitpunkt })
                    .HasName("idx_PflegeEintrag");
            ...
            modelBuilder.Entity<Protocol>(entity =>
            {
                ...
                entity.HasIndex(e => new { e.Info, e.Progress, e.Type, e.SKey, e.CreatedDay })
                    .HasName("idx_TypeKeyCreatedDay");
            ...
            modelBuilder.Entity<TblRedist>(entity =>
            {
                ...
                entity.Property(e => e.Classifiaction)
                    .IsRequired()
                    .HasColumnName("classifiaction")
                    .HasDefaultValueSql("('')");
            ...
            modelBuilder.Entity<ZusatzGruppeEintrag>(entity =>
            {
                ...
                entity.Property(e => e.AktivJn)
                    .IsRequired()
                    .HasColumnName("AktivJN")
                    .HasDefaultValueSql("((1))");
