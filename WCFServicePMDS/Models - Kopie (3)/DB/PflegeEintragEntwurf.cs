...
{
    public partial class PflegeEintragEntwurf
    {
        ...
        public string LstSelectedCc { get; set; }
        public string LstSelectedPatient { get; set; }
        public Guid? FuerUserErstellt { get; set; }
